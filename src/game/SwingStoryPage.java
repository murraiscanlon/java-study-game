...
public class SwingStoryPage extends JFrame {
	...
	private void setUpScroll() {
		...
		story.setText("Before you lies a looming castle, " + "its moss-covered towers dark and damp. "
				+ "A great enemy has overrun the castle and " + "captured Wizard Arvind, the most powerful "
				+ "wizard in all the land. Your mission is " + "to defeat the lurking Java Monsters by"
				+ "\r\nstealing their treasure, a feat which " + "can only be accomplished by correctly answering"
