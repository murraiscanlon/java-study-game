...
public class SwingEnterPageM2 {
    ...
    private void initialize() {
		...
		image.setIcon(new ImageIcon("C:\\Users\\Murrai.Scanlon\\Desktop\\github\\final-project-team-30\\enter0.jpg"));
		image.setBounds(10, 10, 1022, 664);
		frame.add(image);
    ...
    public static void main(String[] args) {
        EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    SwingEnterPageM2 window = new SwingEnterPageM2();
